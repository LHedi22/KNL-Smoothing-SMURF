...
export type FraudDecision = "OK" | "FLAG";
...
export interface FraudCheckResult {
  overallDecision: FraudDecision;
  summary: string;
  confidence: number;
  realNormals: FraudScoreBreakdown[];
  syntheticFraud: FraudScoreBreakdown;
  contributingFeatures: FraudFeatureContribution[];
}
